...
- [Torne-se um programador](https://www.youtube.com/user/Didox59) - Aqui você vai encontrar conteúdo sobre desenvolvimento de aplicações Web, Windows, Mobile e Console, Back-end e Front-end desde a lógica de programação, nas linguagens JavaScript, C#, Ruby, PHP, e as de marcação como HTML, XML, Json, CSS. _Tags: `.net`, `javascript`, `node.js`, `ruby`, `php`, `html`, `css`_
